...
Our goal is to provide a space where it is safe for everyone to contribute to, and get support for, open-source wiki in a respectful and cooperative manner.
...
We aim to have this repository be the guide all students can find and share information they value.
...
This CoC shall apply to all projects ran under the DKU-CS organization and all official communities outside of GitHub.
